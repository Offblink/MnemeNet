...
cp skills/mnemenetnet/SKILL.md ~/.omp/agent/skills/mnemenetnet/SKILL.md
```
...
- `~/.omp/agent/skills/mnemenetnet/SKILL.md` 存在
...
| **保底载体** | `~/.omp/agent/skills/mnemenetnet/SKILL.md` | agent 的认知框架 | 永不 |
